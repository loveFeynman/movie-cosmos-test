...
func CmdCreateMovie() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "create-movie [title] [description] [year]",
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			msg := types.NewMsgCreateMovie(clientCtx.GetFromAddress().String(), argTitle, argDescription, argYear)
...
func CmdUpdateMovie() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "update-movie [id] [title] [description] [year]",
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			msg := types.NewMsgUpdateMovie(clientCtx.GetFromAddress().String(), id, argTitle, argDescription, argYear)
			if err := msg.ValidateBasic(); err != nil {
				return err
			}
			return tx.GenerateOrBroadcastTxCLI(clientCtx, cmd.Flags(), msg)

...
export interface MovieMsgCreateMovieResponse {
  /** @format uint64 */
  id?: string;
}
 ...
 */
export type MovieParams = object;

export interface MovieQueryAllMovieResponse {
  Movie?: MovieMovie[];
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryMovieAll
   * @summary Queries a list of Movie items.
   * @request GET:/movie/movie/movie
   */
  queryMovieAll = (
    query?: {
    ...
    this.request<MovieQueryAllMovieResponse, RpcStatus>({
      path: `/movie/movie/movie`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryMovie
   * @summary Queries a Movie by id.
   * @request GET:/movie/movie/movie/{id}
   */
  queryMovie = (id: string, params: RequestParams = {}) =>
    this.request<MovieQueryGetMovieResponse, RpcStatus>({
   ...
   * @request GET:/movie/movie/params
   */
